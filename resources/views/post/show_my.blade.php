...
<style>
    ...
    @section('content')
        <div class="container my-5">
            <a href="{{route('post.destroy', $post->id)}}" class="btn btn-outline-light me-auto"><i class="fa-solid fa-trash"></i></a>
            <a href="{{route('post.edit', $post->id)}}" class="btn btn-outline-light"><i class="fa-solid fa-pen-to-square"></i></a>
