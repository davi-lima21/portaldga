...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        @foreach ($posts as $post)
            <div class="bg-green m-auto mt-4 pb-3 col-md-5 col-12 pb-2 rounded text-center shadow-lg post">
                <a href="{{route("post.show", $post->id)}}" class="text-decoration-none text-light">
